...
class PlanningGraph():
    ...
    def add_literal_level(self, level):
        ...
        for A_node in self.a_levels[level - 1]:
            ...
            self.s_levels[level] = self.s_levels[level] | S_nodes
            A_node.children = A_node.children | S_nodes
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        for clause in node_a2.action.effect_add:
            if clause in node_a1.action.effect_rem:
                return True   
        return False
    ...
    def competing_needs_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        for a1_Pnode in node_a1.parents:
            for a2_Pnode in node_a2.parents:
                if a1_Pnode.is_mutex(a2_Pnode):
                    return True
        return False
    ...
    def inconsistent_support_mutex(self, node_s1: PgNode_s, node_s2: PgNode_s):
        ...
        for s1_Pnode in node_s1.parents:
            for s2_Pnode in node_s2.parents:
                if not s1_Pnode.is_mutex(s2_Pnode):
                    return False
        return True
